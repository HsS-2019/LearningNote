...
> 某些时候，我们也会通过在源码中内嵌汇编代码的方式，提高执行效率和提高安全性
...
[崩溃分析汇编基础](https://www.jianshu.com/p/4f91a1effed5)
...
* Xcode的Device Support下会有部分iOS系统版本对应的系统库符号文件
* 从iOS 10起，iOS的固件不再加密，我们可通通过固件获取对应符号表
...
后续和作者讨论了一下，第二个方案基本是要做一定的取舍，第一种方案可以下发dsym文件，并制定堆区的查找规则，只解析前几层。
...
[iOS中的内嵌汇编](https://mp.weixin.qq.com/s/tmPLMgMQdzeeddiN2nCCyg)

本文通过将一个OC的函数汇编化的例子，向我们讲解了iOS汇编的一些知识以及全汇编实现的一些注意点
